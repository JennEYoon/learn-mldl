 ...
 * Firefox browser on Ubuntu -- works now. VcXsrv added to .bashrc 
    * Jupyter notebook auto-opens firefox browser with session, but seems fuzzy resolution.
    ------------
    * Update 8/20/2019, removed VcXSrv from Windows Startup Items (disabled).  
    * Keeps asking for re-configuration, even after it is saved.
    * Fix later.  Now, copy URL to Chrome to start jupyter notebook.
    ---------------
...
--------------
#### Fastai Symlink Ubunty 9/2/2019  

Courses 2018, dl1 classes has symlink to /old/fastai
